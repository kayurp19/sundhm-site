...
CASE_MIXED_USE_BODY = CASE_HERO_TEMPLATE.format(
    ...
    lead="SUNdhm was engaged to take operating control of a long-vacant mixed-use commercial building in Upstate New York — 22 residential units and 3 ground-floor retail bays. Within 12 months, life-safety systems were re-certified, residential and commercial space were brought back online, and the asset reached a stabilized run-rate."
) + '''
<section class="section">
  <div class="container" style="max-width: 820px;">
    ...
    <div class="case-detail__grid">
      ...
      <div class="case-detail__meta-block">
        ...
        <p class="case-detail__meta-val">22 residential units &middot; 3 ground-floor retail bays</p>
      </div>
      <div class="case-detail__meta-block">
    ...
    <h2 class="serif case-detail__h2">Situation at Engagement</h2>
    <p>A small-format mixed-use commercial building — ground-floor retail with four floors of apartments above — had sat fully vacant for approximately four years. Storefronts were papered over, residential floors were empty, and the property had drifted out of compliance on multiple life-safety items. Mechanical systems had been left unserviced through several winters, and the boiler had failed mid-cycle and was no longer operable. Despite the prolonged vacancy, the building shell was structurally sound: roof intact, masonry stable, and most original architectural elements (tin ceiling, oak stair, plaster walls, wood floors) recoverable.</p>
    <p>SUNdhm was engaged to take operating control of the asset, restore code and life-safety compliance, complete a measured restoration of the residential and commercial spaces, and execute a deliberate lease-up across both components.</p>

    <h2 class="serif case-detail__h2">Strategic Interventions</h2>
    <ul class="spec-list">
      <li><strong>Life-safety re-certification.</strong> Fire panel tested and re-certified, sprinkler riser drained and inspected with the local AHJ, smoke and CO detection brought current across all floors.</li>
      <li><strong>Mechanical &amp; envelope restoration.</strong> Boiler replaced and steam risers pressure-tested floor by floor; roof flashing repaired; supply-line water damage on the third floor remediated; back-of-house electrical panels brought up to code.</li>
      <li><strong>Residential restoration &amp; preservation.</strong> Apartments restored with original window casings, plaster walls, and wide-plank pine floors preserved where serviceable (18 of 22 units retained original architectural features). Targeted unit-by-unit refresh rather than a uniform gut renovation.</li>
      <li><strong>Commercial lease-up &amp; tenant curation.</strong> Three ground-floor retail bays brought to leasable condition; corner bay leased to an independent food &amp; beverage operator; secondary bay leased to a service tenant; third bay held strategically pending the right use.</li>
      <li><strong>Residential leasing program.</strong> Marketing relaunch, model unit, and a measured lease-up cadence targeting mid-market positioning for the submarket. First tenant move-in approximately 240 days after possession.</li>
      <li><strong>Operating &amp; reporting cadence.</strong> Standard SUNdhm reporting stack stood up from day one: monthly P&amp;L, rent roll, capex tracking, and KPI dashboard delivered to ownership.</li>
    </ul>

    <h2 class="serif case-detail__h2">Results at the One-Year Mark</h2>
    <ul class="case-card__metrics" style="margin-top: 8px;">
      ...
      <li><strong>Effective gross income:</strong> $0 → stabilized run-rate</li>
      <li><strong>Operating expense ratio:</strong> low 40s of EGI</li>
      <li><strong>Time to first tenant move-in:</strong> ~240 days from possession</li>
      <li><strong>Residential lease-up trajectory:</strong> ~12 months</li>
      <li><strong>Life-safety status:</strong> all open items resolved &amp; re-certified</li>
      <li><strong>Architectural preservation:</strong> original casings, floors, and stair preserved in 18 of 22 units</li>
    </ul>

    <h2 class="serif case-detail__h2">Outcome</h2>
    <p>The asset moved from full vacancy to a stabilized run-rate within twelve months of takeover. Both residential and commercial components are producing income, code and life-safety status is current, and the building&rsquo;s original architectural character has been preserved where it carries economic and civic value. The property is positioned for long-term hold or refinance.</p>

    <h2 class="serif case-detail__h2">Relevance to Distressed &amp; Transitional Assets</h2>
    <p>This engagement illustrates SUNdhm&rsquo;s approach to neglected mixed-use commercial properties: hands-on operating takeover, disciplined sequencing of life-safety and mechanical restoration, preservation of original building character where it carries value, and patient, deliberate lease-up across residential and commercial components. The pattern is broadly applicable to small-format commercial buildings in secondary markets that have lapsed into vacancy but remain structurally sound.</p>
